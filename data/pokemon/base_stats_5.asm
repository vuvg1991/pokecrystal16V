...
INCLUDE "data/pokemon/base_stats/espurr.asm"      ; ESPURR
INCLUDE "data/pokemon/base_stats/meowstic.asm"    ; MEOWSTIC
INCLUDE "data/pokemon/base_stats/honedge.asm"     ; HONEDGE
INCLUDE "data/pokemon/base_stats/doublade.asm"    ; DOUBLADE
INCLUDE "data/pokemon/base_stats/aegislash.asm"   ; AEGISLASH
INCLUDE "data/pokemon/base_stats/spritzee.asm"    ; SPRITZEE
INCLUDE "data/pokemon/base_stats/aromatisse.asm"  ; AROMATISSE
INCLUDE "data/pokemon/base_stats/swirlix.asm"     ; SWIRLIX
INCLUDE "data/pokemon/base_stats/slurpuff.asm"    ; SLURPUFF
...
INCLUDE "data/pokemon/base_stats/klefki.asm"      ; KLEFKI
